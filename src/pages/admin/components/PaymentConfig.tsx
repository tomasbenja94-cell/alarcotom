...
export default function PaymentConfig() {
  ...
  useEffect(() => {
    try {
      // Cargar desde localStorage (frontend es local, no usar Supabase)
      ...
      if (localConfig) {
        try {
          ...
          console.warn('Error parseando configuración de localStorage:', e);
        }
      }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Frontend es local, no usar Supabase - solo localStorage
